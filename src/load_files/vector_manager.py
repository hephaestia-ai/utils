...
class VectorManager(Client):
    ...
    def add_record(self, *args):
        ...
        """
        if len(args) != 1:
            raise ValueError("Two arguments are required: directory and file extension.")
    ...
    def delete_all(self):
        ...
        confirmation = input("Are you sure you want to delete all? (y/N): ").strip().lower()
        if confirmation == 'y':
    ...
    def retrieve_vector(self, vector_id):
        ...
        return self.client.beta.vector_stores.retrieve(vector_store_id=vector_id)
    ...
    def get_vector_file_counts(self, vector_id):
        ...
        logging.info(f"""Vector File Counts
